...
const TICKERS = [
  ...
  { sym: "TCS",      price: 3921.10, change: -0.43 },
  { sym: "INFY",     price: 1876.55, change: +2.11 },
  { sym: "HDFCBANK", price: 1654.20, change: -0.78 },
  { sym: "ICICIBANK",price: 1123.45, change: +0.92 },
  { sym: "SBIN",     price:  812.30, change: +1.67 },
  { sym: "AXISBANK", price:  987.65, change: -1.34 },
  { sym: "WIPRO",    price:  524.80, change: +0.55 },
  { sym: "HCLTECH",  price: 1432.90, change: +3.21 },
  { sym: "ITC",      price:  498.15, change: -0.22 },
  { sym: "MARUTI",   price:12340.00, change: +0.88 },
  ...
  useEffect(() => {
    const id = setInterval(() => {
      setData(prev => prev.map(t => ({
        ...t,
        price: parseFloat((t.price * (1 + (Math.random() - 0.499) * 0.002)).toFixed(2)),
...
function Sparkline({ positive }: { positive: boolean }) {
  const points = useRef(
    Array.from({ length: 20 }, (_, i) => 50 + Math.sin(i * 0.6) * 20 + Math.random() * 15)
  );
  const pts = points.current.map((y, x) => `${x * 5},${100 - y}`).join(" ");
  const color = positive ? "#10b981" : "#f43f5e";
  return (
    <svg width="60" height="24" viewBox="0 0 95 100" preserveAspectRatio="none">
      <polyline points={pts} fill="none" stroke={color} strokeWidth="2.5" strokeLinejoin="round" opacity="0.8"/>
    </svg>
  );
}
    ...
    <div style={{
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <span style={{ fontSize: 11, color: "#4ade80", letterSpacing: "0.12em" }}>NSE LIVE</span>
          </div>
        ...
        <div style={{ padding: "40px 32px 24px" }}>
          <div style={{ fontSize: 10, color: "#334155", letterSpacing: "0.2em", marginBottom: 12 }}>
            AI-POWERED SIGNALS
          </div>
          <div style={{
            ...
            Predict the<br/>
            <span style={{ color: "#06b6d4" }}>market</span><br/>
            before it moves.
          </div>
          <div style={{ marginTop: 16, fontSize: 12, color: "#475569", lineHeight: 1.6 }}>
            XGBoost + LSTM ensemble<br/>trained on NSE historical data.
          </div>
        </div>
        ...
        <div style={{ padding: "0 32px" }}>
          <div style={{
            ...
            gap: "0 16px", fontSize: 10, color: "#334155",
            letterSpacing: "0.1em", paddingBottom: 8,
            borderBottom: "1px solid rgba(255,255,255,0.05)",
          }}>
            <span>SYMBOL</span><span>PRICE</span><span>CHG%</span><span>7D</span>
          </div>
          {tickers.map((t) => {
            ...
            return (
              <div key={t.sym} style={{
                ...
                <span style={{ fontSize: 11, color: "#94a3b8", fontWeight: 500 }}>{t.sym}</span>
                <span style={{
                  fontSize: 12, color: "#e2e8f0", fontVariantNumeric: "tabular-nums",
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: "radial-gradient(circle at bottom right, rgba(6,182,212,0.06), transparent 70%)",
          pointerEvents: "none",
        }}/>
        ...
        <div style={{ width: "100%", maxWidth: 380, position: "relative", zIndex: 1 }}>
          ...
          <div style={{ marginBottom: 48 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 32 }}>
              ...
              <span style={{ fontSize: 15, fontWeight: 600, color: "#f1f5f9", letterSpacing: "-0.01em", fontFamily: "var(--font-display, sans-serif)" }}>
                NeuralTrade
              </span>
            </div>

            <div style={{ fontSize: 26, fontWeight: 300, color: "#f1f5f9", letterSpacing: "-0.02em", lineHeight: 1.2, fontFamily: "var(--font-display, sans-serif)" }}>
              Welcome back
            </div>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div style={{ marginBottom: 16 }}>
              <label style={{ display: "block", fontSize: 11, color: "#475569", marginBottom: 6, letterSpacing: "0.1em" }}>
                EMAIL
              </label>
            ...
            <div style={{ marginBottom: 28 }}>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
                <label style={{ fontSize: 11, color: "#475569", letterSpacing: "0.1em" }}>PASSWORD</label>
              </div>
              <div style={{ position: "relative" }}>
                <input
                  ...
                  style={{
                    ...
                    fontFamily: "inherit",
                    transition: "border-color 0.15s",
                    boxShadow: focusedField === "password" ? "0 0 0 3px rgba(6,182,212,0.1)" : "none",
                  }}
                />
            ...
            <button type="submit" disabled={submitting} style={{
              ...
              {submitting ? (
                <>
                  <span style={{
                    width: 14, height: 14, border: "2px solid rgba(5,8,16,0.3)",
                    borderTopColor: "#050810", borderRadius: "50%",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, margin: "24px 0" }}>
            ...
            <span style={{ fontSize: 11, color: "#334155", letterSpacing: "0.1em" }}>NO ACCOUNT?</span>
            <div style={{ flex: 1, height: 1, background: "rgba(255,255,255,0.06)" }}/>
          </div>
